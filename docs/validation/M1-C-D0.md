...
**下一子阶段：M2-A 身份、工作区与权限。**[PR #11](https://github.com/iwbinb/ArcBox/pull/11) 已由用户合并到 `main`（`3f6fc80`）。后续单独的 [Demo 自动部署接入](DEMO-AUTO-DEPLOY.md)有自己的激活与验证状态，不改变本次手动部署的历史证据。
